...
export const useAdvisor = () => {
  ...
  const { profile, assignedStudents, dashboardStats, sessions, studentProgress, graduationAudit, issues, loading, statsLoading, error } = useSelector((s) => s.advisor);

  return {
    profile, assignedStudents, dashboardStats, sessions, studentProgress, graduationAudit, issues, loading, statsLoading, error,
