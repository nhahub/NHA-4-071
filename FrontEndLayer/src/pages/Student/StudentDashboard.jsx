...
const btnOutline = "flex flex-row items-center px-4 py-2 gap-2 border border-text-muted rounded-lg bg-transparent text-primary font-body font-normal text-base leading-normal cursor-pointer";
  ...
  return (
    <div className="flex flex-col gap-[44px] max-w-[960px] mx-auto">
      ...
      <div className="flex gap-4 w-full">
        ...
        <KPICard label="ACADEMIC STANDING" borderColor="#765B00">
          <div className="flex flex-row items-center gap-2 w-full">
            <span className="flex flex-col items-start px-3 py-1 bg-[rgba(201,167,77,0.2)] rounded-full font-body font-normal text-base leading-normal text-warning">
              Good Standing
            </span>
          </div>
        </KPICard>
      ...
      <div className="flex gap-6 w-full">
        <div className="flex-[2] flex flex-col p-8 pb-[112px] gap-6 bg-white shadow-sm rounded-xl">
          ...
          {trendData.length === 0 ? (
            <div className="flex items-center justify-center h-[240px] font-heading text-text-muted">
        ...
        <div className="flex-1 flex flex-col justify-between p-8 gap-6 bg-primary rounded-xl shadow-md min-h-[440px]">
          <div className="flex flex-col gap-2">
            <h3 className="font-heading font-semibold text-2xl m-0 text-white">
              Major Completion
            </h3>
            <p className="font-heading font-normal text-base m-0 text-[rgba(233,221,255,0.8)]">
          ...
          <div className="flex flex-col gap-4 py-8">
            {courseProgressData.length > 0 ? courseProgressData.map((course) => (
              <div key={course.code}>
                <div className="flex justify-between items-center">
                  <span className="font-body text-base text-white/80">{course.name}</span>
                  <span className="font-body text-base text-white">{course.percent}%</span>
                </div>
                <ProgressBar value={course.percent} max={100} color="#FFFFFF" height={8} />
              </div>
            )) : (
              <div className="font-body text-base text-white/60 text-center py-4">
          ...
          <button
            ...
            className="flex justify-center items-center py-3 w-full bg-white rounded-lg border-none text-primary font-heading font-bold text-base cursor-pointer"
          >
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-center">
          ...
          <span
            className="font-body font-normal text-base text-primary cursor-pointer"
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden">
          <div className="flex flex-row justify-between items-center px-8 py-3 bg-bg-light">
                ...
                {semesterCourses.length === 0 ? (
                  ...
                  semesterCourses.map((course, i) => (
                    <tr key={course.code} className={i > 0 ? "border-t border-border" : ""}>
                      <td className="px-8 py-[18.5px] font-body font-normal text-base text-primary">
                        {course.code}
                      </td>
                      ...
                      <td className="px-8 py-[18px] font-heading font-bold text-base text-warning text-right">
                        {course.grade}
                      </td>
                    </tr>
                  ))
